...
migrateup: 
	migrate -path migrations/ -database "postgresql://root:secret@localhost:5432/students?sslmode=disable" -verbose up

migratedown:
	migrate -path migrations/ -database "postgresql://root:secret@localhost:5432/students?sslmode=disable" -verbose down
